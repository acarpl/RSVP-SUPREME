...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<FieldType>|FieldType query()
     ...
     */
    class FieldType extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * App\Models\Lapangan
     *
     * @method static \Illuminate\Database\Eloquent\Builder<Lapangan>|Lapangan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lapangan>|Lapangan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Lapangan>|Lapangan query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Lapangan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<OrderItem>|OrderItem wherePriceAtTime($value)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $midtrans_response
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment whereMidtransTransactionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment whereMidtransOrderId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment wherePaymentType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment whereTransactionStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment whereFraudStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Payment>|Payment whereMidtransResponse($value)
    ...
    /**
     * App\Models\Reservasi
     *
     * @method static \Illuminate\Database\Eloquent\Builder<Reservasi>|Reservasi newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Reservasi>|Reservasi newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Reservasi>|Reservasi query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Reservasi extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Review>|Review whereReviewedType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Review>|Review whereReviewedId($value)
