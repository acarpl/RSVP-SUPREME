    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h1 class="fw-bold text-brand mb-0">Tambah Produk</h1>
                    <p class="text-muted mb-0">Lengkapi informasi produk baru untuk ditampilkan di toko.</p>
                </div>
            </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="category"
                                        ...
                                        <option value="alat" {{ old('category') == 'alat' ? 'selected' : '' }}>
                                        ...
                                        <option value="merchandise" {{ old('category') == 'merchandise' ? 'selected' : '' }}>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description"
                                              class="form-control"
                                              rows="3"
                                              placeholder="Contoh: Bahan polyester, ukuran S/M/L, cocok untuk latihan & pertandingan">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="text-center mb-4">
                                    <div class="position-relative d-inline-block">
                                        <img id="imagePreview"
                                             src="https://placehold.co/300x300/e2e8f0/94a3b8?text=+"
                                             alt="Preview"
                                ...
                                <div class="mb-4">
                                    <label class="form-label fw-medium">Foto Produk <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="file"
                                               name="image"
                                               id="imageUpload"
                                ...
                                <div class="alert alert-light border-0 rounded-3 p-3 mb-0">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <small class="text-muted">
                                            Foto produk yang jelas akan meningkatkan minat pembeli. Gunakan latar belakang polos dan pencahayaan cukup.
                                        </small>
                                    </div>
                                </div>
                            </div>
